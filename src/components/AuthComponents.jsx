...
import { CheckCircle2, Mail, Lock, User, Eye, EyeOff, ArrowRight } from 'lucide-react';
...
const AuthComponents = () => {
  ...
  const handleloginSubmit = async () => {
    try{
      const response = await axiosInstance.post("Task/token/", {
        username: username,
        password: password,
      });
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-3 rounded-lg hover:shadow-lg transition-all font-medium flex items-center justify-center space-x-2 group"
              >
